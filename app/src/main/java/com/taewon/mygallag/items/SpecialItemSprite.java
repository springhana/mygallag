...
public class SpecialItemSprite extends Sprite {
    SpaceInvadersView game;

    public SpecialItemSprite(Context context, SpaceInvadersView game, int x, int y, int dx, int dy) {
        super(context, R.drawable.special_item, x, y);
        this.game = game;
        this.dx = dx;
        this.dy = dy;
